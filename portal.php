...
<header class="masthead">
	<div class="container">
		<div class="masthead-subheading">Du Lịch Nhật Bản</div>
		<div class="masthead-heading text-uppercase">Đường đi ở dưới chân. Cứ đi rồi sẽ đến
</div>
		<a class="btn btn-primary btn-xl text-uppercase" href="#home">Khám Phá</a>
	</div>
</header>
<!-- Services-->
